...
const Navbar = () => {
  return (
    <nav className="w-full p-4 text-blue-500 flex justify-center flex-col items-center gap-4">
      {/* <Link
        className="hover:bg-white hover:text-blue-500 py-6 px-8 transition-all"
        href={"/"}
      >
        Home
      </Link> */}
